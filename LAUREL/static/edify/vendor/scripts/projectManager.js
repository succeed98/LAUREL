$(function () {
    ...
    $("#modalEditQuiz").iziModal();
    $("#modalEditAssignment").iziModal();
    $("#modalAddLesson").iziModal();
    $("#modalAddSchools").iziModal();
    ...
    $('.addNewSchools').click(function () {
        $('#modalAddSchools').iziModal('open');
        $('#modalAddSchools').iziModal('setTop', 100);
        $('#modalAddSchools').iziModal('setBottom', 140);
        $('#modalAddSchools').iziModal('setHeaderColor', '#5567FF');
        $('#modalAddSchools').iziModal('setBackground', '#eeeeee');

    });


    $('.AddNewLesson').click(function () {
        $('#modalAddLesson').iziModal('open');
        $('#modalAddLesson').iziModal('setTop', 100);
        $('#modalAddLesson').iziModal('setBottom', 140);
        $('#modalAddLesson').iziModal('setHeaderColor', '#5567FF');
        $('#modalAddLesson').iziModal('setBackground', '#eeeeee');
    ...
    $('.EditQuiz').click(function () {
        $('#modalEditQuiz').iziModal('open');
        $('#modalEditQuiz').iziModal('setTop', 100);
        $('#modalEditQuiz').iziModal('setBottom', 100);
        $('#modalEditQuiz').iziModal('setHeaderColor', '#128EC0');
        $('#modalEditQuiz').iziModal('setBackground', '#eeeeee');

    });


    //Pop-up Editing Assignment
    $('.EditAssignment').click(function () {
        $('#modalEditAssignment').iziModal('open');
        $('#modalEditAssignment').iziModal('setTop', 100);
        $('#modalEditAssignment').iziModal('setBottom', 100);
        $('#modalEditAssignment').iziModal('setHeaderColor', '#128EC0');
        $('#modalEditAssignment').iziModal('setBackground', '#eeeeee');
